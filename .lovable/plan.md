...
3. Those computed values plus recent price action go to Lovable AI, which returns a structured verdict: direction, confidence, entry, stop loss, targets, and the reasoning bullets.
